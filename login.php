      ...
      <div class="container">
        ...
        <nav class="navbar container" data-navbar>
          <ul class="navbar-list">
            <li>
              <a href="/Applications/XAMPP/xamppfiles/htdocs/index.php" class="navbar-link" data-nav-link>Home</a>
            </li>
            <li>
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="tel:+91-8847-072-592" class="footer-link">+91-8847-072-592</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
