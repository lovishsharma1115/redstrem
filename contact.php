...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["email_address"]) && filter_var($_POST["email_address"], FILTER_VALIDATE_EMAIL)) {
        ...
        if ($stmt->affected_rows > 0) {
            $popupMessage = "Email added successfully!";
        } else {
            $popupMessage = "Error: Unable to add email. Please try again later.";
        }

        $stmt->close();
        $conn->close();
    } else {
        $popupMessage = "Error: Invalid email address. Please enter a valid email.";
    }
}
?>
<!DOCTYPE html>
      ...
      <div class="container">
        <ul class="contact-list">
          <li class="contact-item">
            ...
            <a href="mailto:lovishsharma1115@gmail.com" class="contact-link">lovishsharma1115@gmail.com</a>
          </li>
          <li class="contact-item">
        ...
        <ul class="social-list">
          ...
          <li>
            <a href="https://www.instagram.com/__lovish__sharma__/" class="social-link">
      ...
      <div class="container">
        ...
        <nav class="navbar container" data-navbar>
          <ul class="navbar-list">
            ...
            <li>
              <a href="http://localhost:8000/service" class="navbar-link" data-nav-link>Find donor</a>
            </li>
            <li>
              <a href="http://localhost:8000/about.html" class="navbar-link" data-nav-link>About Us</a>
            </li>
            <li>
              <a href="http://localhost:8000/blog" class="navbar-link" data-nav-link>Blog</a>
            </li>
            <li>
              <a href="http://localhost:8000/contact.php" class="navbar-link" data-nav-link>Contact</a>
            </li>
          </ul>
        </nav>
    ...
    <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')"
        ...
        <div class="container">
          <div class="hero-content">
            ...
            <p class="hero-text">
            MOBILE: +91 9646585003| TELEPHONE: 9646585003<br>
            EMAIL : lovishsharma1115@gmail.com<br>
            </p>
